alter function public.publish_authoring_document_core(uuid, bigint, jsonb)
  set schema private;

revoke all on function private.publish_authoring_document_core(uuid, bigint, jsonb)
  from public, anon;
grant execute on function private.publish_authoring_document_core(uuid, bigint, jsonb)
  to authenticated;
